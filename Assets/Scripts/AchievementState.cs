...
public class AchievementState {
    ...
    public delegate string TextForAchievement(Achievement achievement);

    public static TextForAchievement[] TextForFunction = {
        TextForAchievementEnglish,
        TextForAchievementRussian,
        TextForAchievementSpanish
    };
    ...
    public static void GiveAchievement(Achievement achievement) {
        ...
        AchievementPopup.instance.ShowAchievement(TextForFunction[(int)LanguageState.language](achievement));
    }
    
    private static string TextForAchievementEnglish(Achievement achievement) {
        return "Achievement Get: " +  (achievement switch {
    ...
    private static string TextForAchievementRussian(Achievement achievement) {
        return "Achievement Get: " +  (achievement switch {
            Achievement.PickupEarth => "Pickup Earth",
            Achievement.PickupFire => "Pickup Fire",
            Achievement.PickupWater => "Pickup Water",
    ...
    private static string TextForAchievementSpanish(Achievement achievement) {
        return "Achievement Get: " +  (achievement switch {
            Achievement.PickupEarth => "Pickup Earth",
            Achievement.PickupFire => "Pickup Fire",
            Achievement.PickupWater => "Pickup Water",
